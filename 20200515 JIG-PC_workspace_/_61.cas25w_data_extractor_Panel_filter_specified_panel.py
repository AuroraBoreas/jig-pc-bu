...
def verify_data_name_data(dn):
    ...
    """
    # wanted conditions
    identifiers_1 = ['100IRE', '50IRE']
    identifiers_2 = ['SCC0003058']
    # ruleout conditions
    wo_identifiers = ['ZOOM', 'MURA', 'SET']
    dn = dn.upper()
    if any(i in dn for i in wo_identifiers):
        return False
    else:
        return any(i in dn for i in identifiers_1) and any(i in dn for i in identifiers_2)
